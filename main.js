...
var domicilioinnerhtml;
    ...
    fs.writeFile( 'C:/Users/Public/senddatasobre.json', `{"nombre": "${nombresobre}", "mail": "${mailinnerhtml}", "telefono": "${telinnerhtml}", "domicilio": "${domicilioinnerhtml}", "documento": "${documentoinnerhtml}", "lente": "cerca", "numcliente": "${clientesobre}"}`,  (error) => {
        if(error){
...
buttonlejos.addEventListener("click", e =>{
    ...
    if(documentodiv != null){
      ...
      /*  mailsobre = document.querySelector("#mailsobre").innerHTML;
        ...
        documentodiv = document.querySelector("#documentosobre").innerHTML;*/
        console.log(clientesobre);
        fs.writeFile( 'C:/Users/Public/senddatasobre.json', `{"nombre": "${nombresobre}", "mail": "${mailsobre}", "telefono": "${telefonosobre}", "domicilio": "${domiciliosobre}", "documento": "${documentodiv}", "lente": "lejos", "numcliente": "${clientesobre}"}`, (error) => {
            if(error){
                console.log(`error: ${error}`);
            }
        })
